...
tsls_2 <- ivreg(children ~ educ+age+age2+electric+tv+bicycle|age+age2+electric+tv+bicycle+frsthalf,data=fertil2) 
summary(tsls_2)
...
```{r ans15}
summary(tsls_2, vcov = sandwich, diagnostics = TRUE, df=Inf) -> tsls_2_tests
sandwich_HC1<-function(x,adjust=TRUE){
  sandwich(x,adjust=adjust)
} 
summary(tsls_2, vcov = sandwich_HC1, diagnostics = TRUE, df=Inf) -> tsls_2iv_tests_hc1
...
```{r ans17}
tsls_3 <-ivreg(children ~ educ+age+age2+electric+tv+bicycle|age+age2+electric+tv+bicycle+frsthalf+catholic,data=fertil2) 
summary(tsls_3)


summary(tsls_3, vcov = sandwich, diagnostics = TRUE, df=Inf) -> tsls_3_tests
sandwich_HC1<-function(x,adjust=TRUE){
  sandwich(x,adjust=adjust)
}
summary(tsls_3, vcov = sandwich_HC1, diagnostics = TRUE, df=Inf) -> tsls_3iv_tests_hc1
